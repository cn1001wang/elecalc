...
;(function () {
  ...
  abp.multiTenancy.setTenantIdCookie = function (tenantId, refreshToken) {
    if (tenantId) {
  ...
  abp.auth.isGranted = function (permissionName) {
    return abp.auth.allPermissions.includes(permissionName)
  }
  ...
  abp.auth.setToken = function (authToken, refreshToken, expireDate) {
    abp.utils.setCookieValue(
  ...
  abp.utils.setCookieValue = function (key, value, expireDate, path, domain) {
    ...
    if (expireDate) cookieValue = cookieValue + '; expires=' + expireDate.toUTCString()
    if (path) cookieValue = cookieValue + '; path=' + path
    if (domain) cookieValue = cookieValue + '; domain=' + domain

    cookieValue = cookieValue + '; SameSite=None; Secure'
  ...
  abp.security.antiForgery.refreshTokenCookieName = 'XSRF-REFRESH-TOKEN'
  abp.security.antiForgery.tokenHeaderName = 'X-XSRF-TOKEN'

  abp.security.antiForgery.getToken = function () {
    return abp.utils.getCookieValue(abp.security.antiForgery.tokenCookieName)
  }
  abp.security.antiForgery.getRefreshToken = function () {
    return abp.utils.getCookieValue(abp.security.antiForgery.refreshTokenCookieName)
  }
